...
7. End the writer session, return Home and test a normal background scan: notification → tap → correct witness page → correct player claim. Check signup, a second witness, duplicate rejection, player recovery and helper-assisted claims. A working link alone does not validate the game.
