...
The [full step-by-step programming checklist](iphone-programming-and-locking.md) includes official Apple/NXP/wakdev evidence, failure handling, app cost and a spare-tag rehearsal. The [tag register](nfc-tag-register.csv) is an empty template, not evidence of completed programming.
