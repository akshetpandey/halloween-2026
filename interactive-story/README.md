...
| Document | Purpose |
|---|---|
| [09 — Narrative and game](09-hollow-court-narrative-and-game.md) | Current rules, mystery, chapters, Summons, voting, scoring and finale |
| [10 — Selected puzzle families](10-puzzle-design-proposals.md) | Finalized fifteen: fourteen approved plus Unbroken Sigil provisional; deterministic generation, retry and distinction rules; no entity assignment |
| [11 — Physical entities](11-physical-entity-plan.md) | Fifteen-slot 5/5/5 plan, reuse, sourcing and build gates |
| [03 — Website brief](03-website-build-brief.md) | Requirements for a later Cloudflare implementation |
| [02 — Volunteer runbook](02-volunteer-runbook.md) | Gossip, helper rules, timing and ceremony |
| [04 — Tracker](04-task-tracker.md) | Documentation, design, sourcing and future build work |
| [01 — Phone feasibility](01-phone-and-nfc-feasibility.md) | Existing device research and real-phone pilot requirements |
| [05 — Figurine construction](05-nfc-creature-figurines.md) | Reusable tag/base techniques and earlier purchase notes |
| [06 — Bark and moon touchpoints](06-bark-spirits-and-moon-touchpoints.md) | Reusable texture/mounting research; all-bark batch is superseded |
| [07 — Amazon shortlist](07-amazon-figurines-and-tags.md) | Previously researched products; older mix/budget retained as history |
| [08 — Programming and locking](08-iphone-programming-and-locking.md) | Future test-before-lock workflow and verification |
